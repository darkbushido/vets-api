  ...
  class PoaUpdater
    ...
    def perform(power_of_attorney_id) # rubocop:disable Metrics/MethodLength
      ...
      if response[:return_code] == 'BMOD0001'
        ...
        ClaimsApi::Logger.log('poa', poa_id: poa_form.id, status: 'BIRLS Success')
        ...
        ClaimsApi::Logger.log('poa', poa_id: poa_form.id, status: 'BIRLS Failed', error: response[:return_code])
      end
